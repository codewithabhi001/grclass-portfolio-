      ...
      <div className="grid gap-10 md:grid-cols-2 md:items-center md:gap-14 lg:gap-20">
        ...
        <div>
          ...
          <p className="mt-5 text-[14.5px] font-light leading-[1.8] text-muted-foreground sm:text-[15px]">
            We operate as an independent recognised organisation, providing classification services,
            statutory certification, and technical advisory to owners, operators, and flag
          ...
          <blockquote className="mt-7 border-l-[3px] border-accent bg-accent-soft px-5 py-4">
