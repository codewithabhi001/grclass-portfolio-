                  ...
                  <Accordion type="single" collapsible className="mt-2">
                    {g.items.map((item: any, i: number) => (
                      <AccordionItem key={i} value={`${g.topic}-${i}`} className="border-b border-border">
                        <AccordionTrigger className="py-5 text-left font-display text-body-lg font-semibold text-primary hover:no-underline">
                          {item.q}
                        </AccordionTrigger>
                        <AccordionContent className="pb-5 text-body-sm font-light text-muted-foreground">
                          {item.a}
                        </AccordionContent>
                      </AccordionItem>
                    ))}
      ...
      <section className="border-t border-border bg-secondary-soft section">
        <div className="container-page flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
          <div>
            ...
            <p className="mt-2 text-body-sm font-light text-muted-foreground">
