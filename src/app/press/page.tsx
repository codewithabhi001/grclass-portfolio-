    ...
    <section className="container-page py-20 md:py-24">
      <div className="grid gap-12 md:grid-cols-12">
        <div className="md:col-span-8">
          ...
          <h2 className="h-display mt-3 text-[clamp(22px,2.2vw,30px)] text-primary">Latest announcements</h2>
          <ul className="mt-10 hairline">
            {releases.map((r) => (
              <li key={r.title} className="grid gap-4 border-b border-border-soft py-6 md:grid-cols-[140px_1fr_auto] md:items-center">
                <time className="font-mono text-[12px] uppercase tracking-wider text-accent">
                  {new Date(r.date).toLocaleDateString("en-GB", { day: "2-digit", month: "short", year: "numeric" })}
                </time>
                <h3 className="h-display text-[17px] text-primary">{r.title}</h3>
        ...
        <aside className="md:col-span-4">
          <div className="border border-border bg-card p-7">
            ...
            <a href={`mailto:press@grclass.com`} className="mt-5 flex items-center gap-3 text-[14px] text-foreground hover:text-secondary">
          ...
          <div className="mt-5 border border-border bg-accent-soft p-7">
            ...
            <p className="mt-3 text-[13.5px] font-light text-foreground/80">
              Logos, executive portraits, and company backgrounder (PDF).
            </p>
            <a href="#" className="mt-4 inline-flex items-center gap-1.5 text-[13px] font-semibold text-primary hover:text-secondary">
