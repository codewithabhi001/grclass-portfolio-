  ...
  <SiteShell>
    ...
    <section className="border-t border-border bg-secondary-soft section">
      <div className="container-page grid gap-12 md:grid-cols-12">
        <div className="md:col-span-5">
          ...
          <p className="mt-5 text-body font-light leading-[1.8] text-muted-foreground">
          ...
          <ul className="mt-5 hairline">
            {reports.map((r) => (
              <li key={r.title} className="grid gap-4 border-b border-border-soft bg-card px-6 py-5 md:grid-cols-[100px_1fr_auto] md:items-center">
                <span className="font-mono text-xs uppercase tracking-wider text-accent">{r.year}</span>
                <div>
                  <div className="font-display text-body-lg font-semibold text-primary">{r.title}</div>
                  <div className="mt-1 text-xs text-subtle">{r.note}</div>
                </div>
                <a href="#" className="inline-flex items-center gap-1.5 text-xs font-semibold text-secondary hover:text-accent">
    ...
    <section className="bg-primary section">
      <div className="container-page flex items-center gap-4 text-background">
        ...
        <p className="text-body-sm">Investor enquiries: <a href="mailto:ir@grclass.com" className="text-accent underline-offset-4 hover:underline">ir@grclass.com</a></p>
      </div>
    </section>
  </SiteShell>
);
