        ...
        <>
          ...
          {sortedNews.length > 0 && (
            <section className="container-page pt-16">
              <Link href={`/news/${sortedNews[0].slug}`} className="group grid gap-10 border-b border-border pb-16 md:grid-cols-12">
                <div className="md:col-span-5">
                  <img 
                    src={typeof sortedNews[0].thumbnail_url === "string" ? sortedNews[0].thumbnail_url : (sortedNews[0].thumbnail_url as any)?.src || newsHero.src} 
          ...
          <section className="container-page py-16 md:py-20">
            <div className="grid gap-px bg-border md:grid-cols-2 lg:grid-cols-3">
              {sortedNews.slice(1).map((n, i) => (
                ...
                >
                  <Link href={`/news/${n.slug}`} className="block p-7">
